...
// Ruta para mostrar observaciones
// Route::get('/observaciones/{numdocum}', [FidemContigoController::class, 'observaciones'])->name('observaciones.show');
...
// Route::get('/ordenesmtlasignar', [OrdenesmtlasignarController::class, 'index'])->name('ordenesmtlasignar');
// Route::get('/orden-ejecutada', [OrdenEjecutadaController::class, 'index'])->name('orden_ejecutada');
...
Route::group(['middleware' => ['auth']], function () {
   ...
   Route::put('novedades{id}', 'Nomina\NovedadesController@update')->name('actualizar_novedades')->middleware('superAnalista');
    ...
    Route::get('fidemcontigo', 'FidemContigoController@index')->name('fidemcontigo.index');
    Route::get('fidemcontigo/analista', 'FidemContigoController@indexAnalista')->name('fidemcontigo.analista');
    Route::get('fidemcontigo/consulta', 'FidemContigoController@indexConsulta')->name('fidemcontigo.consulta');
    Route::get('fidemcontigo/informe', 'FidemContigoController@indexInforme')->name('fidemcontigo.informe');
